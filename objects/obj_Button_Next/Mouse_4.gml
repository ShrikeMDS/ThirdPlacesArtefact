...
else if (room == rm_Tutorial)
{
    ...
    obj_Tutorial_Text.text_header = Tutorial_Text[Tutorial_Text_Num][0];
    obj_Tutorial_Text.text_header2 = Tutorial_Text[Tutorial_Text_Num][1];
}
...
if (obj_Tutorial_Text.text_header == targeted_text_header_1 && obj_Tutorial_Text.text_header2 == targeted_text_header2_1)
{
...
if (obj_Tutorial_Text.text_header == targeted_text_header_2 && obj_Tutorial_Text.text_header2 == targeted_text_header2_2)
{
...
if (obj_Tutorial_Text.text_header == targeted_text_header_3 && obj_Tutorial_Text.text_header2 == targeted_text_header2_3)
{
    // Set the visibility of obj_Arrow_2 to true
...
if (obj_Tutorial_Text.text_header == targeted_text_header_4 && obj_Tutorial_Text.text_header2 == targeted_text_header2_4)
{
    // Set the visibility of obj_Arrow_2 to true
